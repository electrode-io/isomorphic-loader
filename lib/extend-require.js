...
ExtendRequire.prototype.interceptLoad = () => {
  if (originalLoad) {
    return;
  }
...
ExtendRequire.prototype.setAssets = (a) => {
  a = a || {};
  a.marked = a.marked || {};
...
ExtendRequire.prototype._logConfigState = (state, action) => {
...
ExtendRequire.prototype._loadAssets = (callback) => {
  const result = {};
...
ExtendRequire.prototype.loadAssets = (callback) => {
...
ExtendRequire.prototype.waitingNotice = () => {
  const now = Date.now();
...
ExtendRequire.prototype.go = (callback) => {
...
ExtendRequire.prototype.deactivate = () => {
  this.config = undefined;
  this.assetsCount = 0;
  if (this.configFileWatcher) {
...
ExtendRequire.prototype.extend = (userConfig, callback) => {
...
const extendRequire = (userConfig, callback) => {
  return instance.extend(userConfig, callback);
}

extendRequire.loadAssets = (callback) => {
