...
ExtendRequire.prototype.interceptLoad = function interceptLoad() {
    ...
    Module._load = function (request, parent, isMain) {
        ...
        return self.originalLoad.apply(this, [request, parent, isMain]);
    };
};
...
ExtendRequire.prototype._loadAssets = function _loadAssets(force, callback) {
    var result = {};
    var self = this;
    ...
    function handleFileChangeEvent(event) {
        if (event !== "change") {
            ...
            self._loadAssets(true, function (err2, res) {
                if (!err2) {
...
ExtendRequire.prototype.loadAssets = function loadAssets(force, callback) {
    ...
    this._loadAssets(force, function (err, result) {
        if (!err) {
